...
public extension Shape {
    ...
    public func scaled(byX x: CGFloat, y: CGFloat) -> Shape {
        var newShape = self
...
public extension Shape {
    ...
    public mutating func rotate(by angle: CGFloat, pivot: Pivot = .center) {
    ...
    public func rotated(by angle: CGFloat, pivot: Pivot = .center) -> Shape {
        var newShape = self
...
public extension Shape {
    ...
    public mutating func reflect(over axis: ReflectionAxis) {
    ...
    public func reflected(over axis: ReflectionAxis) -> Shape {
        var newShape = self
    ...
    public mutating func flip(_ orientation: Flip) {
        switch orientation {
    ...
    public func flipped(_ orientation: Flip) -> Shape {
        switch orientation {
